...
Router::prefix('admin', function ($routes) {
    ...
    $routes->connect('/stnd', array('plugin' => '','controller' => 'Casinos','action' => 'index'));
...
Router::scope('/', function (RouteBuilder $routes) {	
	...
	$routes->connect(
		...
		['plugin' => '','controller' => 'Users','action' => 'updt_cntry'],

		['pass' => ['country_view','cid','img_name']]
	...
	$routes->connect('/online-casinos-filter', ['plugin' => '','controller' => 'casinos', 'action' => 'onlinecasinoFilter']);



	$routes->connect('/promotion-filter', ['plugin' => '','controller' => 'promotions', 'action' => 'promotionFilter']);
  ...
  $routes->connect('/city_autocomplete/city/*', ['plugin' => '','controller' => 'users', 'action' => 'city_autocomplete']);
    ...
    $routes->connect(
		...
		'/promotions/headerSearch',

		['plugin' => '','controller' => 'promotions','action' => 'headerSearch']
...
/*
	...
	$routes->connect('/filter_game', ['plugin' => '','controller' => 'Casinos', 'action' => 'getdepositMethodTM']);
	
	$routes->connect('/filter_paymetmethod', ['plugin' => '','controller' => 'Casinos', 'action' => 'getpaymentdevices']);
	...
	$routes->connect(
		...
		'/:language/casinos/:cityslug',

		['plugin' => '','controller' => 'users','action' => 'cityCasino'],
	...
	$routes->connect(
		...
		['plugin' => '','controller' => 'users','action' => 'demo']
	);
	...
	//$routes->connect('/city-casinos', ['plugin' => '','controller' => 'users', 'action' => 'cityCasino']);

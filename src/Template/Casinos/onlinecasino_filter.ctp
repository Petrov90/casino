...
<div class="mid_wrapper onlinecasino-mid">
   <div class="casinoSearch casinoSearch1">
      <div class="container">
          <div class="title">
            <h2><?php if(!empty($sub_title)){ echo  $sub_title; }else{ echo (!empty($headBlock->_translations[$Defaultlanguage]->sub_title)) ? $headBlock->_translations[$Defaultlanguage]->sub_title : $headBlock->_translations['en']->sub_title ;}  ?></h2>
          </div>
      <div class="row">
         <div class="col-md-8">
            <div class="filter_2N new-block">
               ...
               <!--<p class="casino-list"><?php //$this->Paginator->param('count'); ?> Casino listed</p>-->
            </div>
         </div>
      </div>
         ...
         <div class="row">
            <div class="col-md-8">
               <div class="clint_info">
                  <div class="data_div">
                     <?php echo $this->element('online_casino_search_filter'); ?>
                  </div>
               </div>
            </div>
            <div class="col-md-4">

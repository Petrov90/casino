...
<?php
    foreach($result as $key => $casino){ ?>
		...
		<?php if($key < 3) { ?>
			<div class="clint_post client_post1 mostcasino"> <?php
		}else{ ?>
			<div class="clint_post client_post1"> <?php
		}?>
...
<?php }
?>
<!-- <div class="Pagination_nav pagi-new"><ul><li class="prev">
<li><a href="/online-casinos-filter?page=2">Next</a></li>
</ul></div> -->
<?php

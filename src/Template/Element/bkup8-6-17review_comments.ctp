...
<div class="commentPostN" id="review_comment_id<?php echo $comments->id; ?>">
	...
	<div class="comntEdit">
		<?php if($comments->user_id != $this->request->session()->read('Auth.User.id')){ ?>
			<a title="Mark As Report Spam" data-type="comment" data-id="<?php echo $comments->id; ?>" href="javascript:void(0);" class="report_as_spam1"><img src="<?php echo WEBSITE_IMG_URL; ?>ic17.png" class="img-responsive" alt="img"></a>

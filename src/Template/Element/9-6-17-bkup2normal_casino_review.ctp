				...
				<div class="memberRiver">
					...
					<div class="cment_sect">
						...
						if($reviews->comment_count > 3){ ?>
								<a href="javascript:void(0);" class="show_all_review_comments" anstxt="Show all answers"  divid="<?php echo $reviews->id; ?>" ans_no="<?php echo count($reviews->comment_count)?>">Show all answers(<qa id="<?php echo $reviews->id; ?>_showall" data-count="<?php echo (!empty($reviews->comment_count)) ? $reviews->comment_count : 0 ;  ?>"><?php echo (!empty($reviews->comment_count)) ? $reviews->comment_count : 0 ;  ?></qa>)</a><?php 
							} ?>

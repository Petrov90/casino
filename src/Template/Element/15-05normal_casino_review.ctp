<?php use Cake\Core\Configure; $showReviewButton	= 	true; ?>
<div class="member_review" ng-app="comment" ng-controller="commentController">
	<div class="member_bord">
	  <div class="member">
		<h2 class="mainheading"><?php echo ($count == 0) ? 'User Reviews' : 'Member Reviews'; ?> (<span id="count_review"><?php echo $count; ?></span>)</h2>
	  </div>
					...
					<div class="revi_memb">
					 <p class="">
						<span class="readonly" data-score="<?php echo $reviews->rating; ?>"></span>
							<span class="h2"><?php echo $reviews->created->format(Configure::read('Date.'.$Defaultlanguage)); ?></span>
					  </p>

			...
			if($review->type == 'city'){
			   ...
			   if(!empty($review->country['casino_images'][0]->file) && file_exists(CASINO_FULL_IMG_ROOT_PATH.$review->country['casino_images'][0]->file)){
				...
				<div class="user-area">
            		...
            		<img  alt="<?php echo $name.' review'; ?>" src="<?php echo WEBSITE_URL.'image.php?width=400px&height=215px&cropratio=2:1&image='.$url; ?>" class="img-responsive " /><span class="user-area-new"><?php echo $name; ?></span></a>
         		</div>
		        <div class="col-md-3">
		            <div class="">

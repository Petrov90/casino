			...
			<div class="member_detail" id="comment_div_<?php echo $reviews->id; ?>">
				...
				<div class="memberRiver">
					...
					<div class="cment_sect">
						...
						<div class="pull-right"><a  data-type="review" href="javascript:void(0)" data-id="<?php echo $reviews->id; ?>" class="report_as_spam1" title="Report"><img src="<?php echo WEBSITE_IMG_URL; ?>ic17.png" class="img-responsive" alt="img"></a></div>
						<?php }

   ...
   <div class="most_info most-info-info">
		...
		if(!empty($promotion->casino->image) && (CASINO_FULL_IMG_ROOT_PATH.$promotion->casino->image)){
			echo $this->Html->image(WEBSITE_UPLOADS_URL.'image.php?width=132px&height=71px&cropratio=2:1&image='.CASINO_FULL_IMG_URL.$promotion->casino->image,['alt' => $promotion->casino->title.' review']);
	...
	} ?></a><div class="col_list cl_num"><span><?php echo $key+1; ?></span></div></div>
				  <div class="Popular_li">
					 ...
					 <p class="readonly read_num" data-score="<?php echo $promotion->casino->avg_rating; ?>"><span><?php echo $promotion->casino->avg_rating; ?></span></p>
				  </div>
			   </div>
			   <div class="col_list new-col-list">
				    <div class="check_list ck">

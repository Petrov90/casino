      ...
      <div class="whole-block">
         ...
         <div class="col-md-9">
            <div class="man-matter">
               <p><a href="<?php echo $this->Url->build(array('plugin' => '','controller' => 'users','action' => 'user_slug' ,'user_slug' => $review->user->slug)); ?>"><span class="style"><?php echo $review->user->full_name; ?></span></a> <?= __('homepage.was_in') ?><a href="<?php echo $htmlurl; ?>"> <span class="style"><?php echo $name; ?></span></a></p>
               <p>
					<img src="<?php echo WEBSITE_IMG_URL; ?>location.png" alt="img" /><?= __('homepage.visited') ?>: <?php echo (!empty($cityName)) ? $cityName.',': ''; ?> <?php echo $review->created->format(Configure::read('Date.'.$Defaultlanguage)); ?></p>

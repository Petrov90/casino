<?php 
// print('Hello in element '.$ff_gametype);
echo $this->Form->create('Promotion',['id' => 'pchec','url' => $this->Url->build(['plugin' => '','controller' => 'casinos','action' => 'onlineCasinoSearch'])]); ?>
  ...
  <div class="pptionsBox side_bar_post">
	 ...
	 <div class="pptionsBoxIn side_bar_ptions">
		...
		<ul><?php foreach($gambling_options as $cat){ ?>
		   ...
		   <li><div class="checbox"><label><?php echo $this->Form->checkbox('gambling_options.'.$cat->id,['class' => 'pr_che','id' => 'g'.$cat->id]); ?><span></span><?php echo $cat->name; ?></label>
		...
		<ul>
		   ...
		   <li>
			  ...
			  <div class="checbox">
				 ...
				 <?php echo $this->Form->checkbox('allowed_country.'.$cat->id,['class' => 'pr_che','id' => 'c'.$cat->id]); ?>

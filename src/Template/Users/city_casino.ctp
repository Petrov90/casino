        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              $url1 = $this->Url->build(array('controller' => 'users','action' => 'city_view','country' => $countrydetails->slug,'city' => $cityDetail->slug)); ?>
              <ul>
                <li><a href="<?php echo $url1; ?>">About <?php echo $cityDetail->name; ?></a></li>
                ...
                <div class="filter_2N new-block">
                   <div class="fil_block new-fil-block">
                      <ul>
                         ...
                         <li class=""><?php echo $this->Paginator->sort('id','Recommended'); ?></li>
             ...
             <div class="row">
                <div class="col-md-8">
                   <div class="clint_info">
                      <div class="data_div">
                         <?php echo $this->element('city_casino_search_filter'); ?>
                      </div>
                   </div>
                </div>
                <div class="col-md-4">

		...
		<div class="container">
		 ...
		 <?php echo $this->Form->end(); 
			...
			if($userDetails->id != $this->request->session()->read('Auth.User.id')){ ?>
				...
				<?php if(in_array('who_can_follow_me_all_users',$preference) || in_array('who_can_follow_me_anyone',$preference) || (in_array('who_can_follow_me_i_follow_him',$preference) && (!empty($userDetails->he_follow_m_e)))){ ?>
					<div class="block">
...
<?php if(in_array('who_can_see_things_on_my_profile_all_users',$preference) || in_array('who_can_see_things_on_my_profile_anyone',$preference) || (in_array('who_can_see_things_on_my_profile_followers',$preference) && (!empty($userDetails->user_follower))) || (in_array('who_can_see_things_on_my_profile_all_users',$preference) && (!empty($this->request->session()->read('Auth.User.id')))) ||($userDetails->id == $this->request->session()->read('Auth.User.id')) ){ ?>

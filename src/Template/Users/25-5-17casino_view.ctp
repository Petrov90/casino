		...
		*/?>
				...
				<div class="casinoDatil casino_dat">
				   ...
				   <div class="casinotable">
					  <span class="hading_h2">Contact information</span>
					  <ul class="casino_detInfo cont-info">
						...
						if(!empty($casino->contact_website)){
							...
							?>
							<div class="col"><img src="<?php echo WEBSITE_IMG_URL ?>Website-min.png" /><a href="<?php echo $web; ?>">Website</a></div>
						<?php }
						if(!empty($casino->contact_facebook)){
							...
							if (false === strpos($Facebook, '://')) {
								...
								<div class="col"><img src="<?php echo WEBSITE_IMG_URL ?>Facebook-min.png" /><a href="<?php echo $Facebook; ?>">Facebook</a></div>
						<?php } ?>
						 </li>
						 <li>
						<?php 
						...
						<?php } 
							if(!empty($casino->contact_twitter)){
								...
								<div class="col"><img src="<?php echo WEBSITE_IMG_URL ?>Twitter-min.png" /><a href="<?php echo $contact_twitter ?>">Twitter</a></div>
							<?php } ?>
						 </li>
						 <li>
						<?php 	
						 ...
						 <li>
							...
							if(!empty($casino->gaming_machines)){
								...
								<div class="col"><img src="<?php echo WEBSITE_IMG_URL ?>Gaming-machines-min.png" /><span>Gaming Machine : <?php echo $gaming_machines; ?></span></div>
							<?php } ?>
						 </li>
						 <li>
						 <?php 
						 ...
						 <li><?php $contact_schedule	=	json_decode($casino->contact_schedule,true);
							if(!empty($contact_schedule)){ ?>
							<div class="col">
							   <img src="<?php echo WEBSITE_IMG_URL ?>Horario-min.png" /><span>Schedule</span>
							  <ul class="tel_info schedule_ul">
								<?php 
								$showSch			=	false;
					  ...
					  <span class="hading_h2">Poker</span>
					  <ul class="casino_detInfo cont-info">
						<li>
						 <?php 
							if(!empty($casino->poker_website)){
								...
								?>
								<div class="col"><img src="<?php echo WEBSITE_IMG_URL ?>Website-min.png" /><a href="<?php echo $poker_website; ?>">Website</a></div>
							<?php } 
							if(!empty($casino->poker_facebook)){
								...
								?>
								<div class="col"><img src="<?php echo WEBSITE_IMG_URL ?>Facebook-min.png" /><span><a href="<?php echo $poker_facebook; ?>">Facebook</a></span></div>
							<?php } ?>
						 </li>
						 <li>
						<?php 
						...
						<?php }  
							if(!empty($casino->poker_tw)){
								...
								<div class="col"><img src="<?php echo WEBSITE_IMG_URL ?>Twitter-min.png" /><a href="<?php echo $poker_tw; ?>">Twitter</a></div>
							<?php } ?>
						 </li>
						 <li>
					  ...
					  <span class="hading_h2">Box Office</span>
					  <ul class="casino_detInfo cont-info">
						<li>
						 <?php 
							if(!empty($casino->bo_web)){
								...
								?>
								<div class="col"><img src="<?php echo WEBSITE_IMG_URL ?>Website-min.png" /><a href="<?php echo $bo_web; ?>">Website</a></div>
							<?php } 
							if(!empty($casino->bo_facebook)){
								$bo_facebook 	=	$casino->bo_facebook;
								if (false === strpos($bo_facebook, '://')) {
									$bo_facebook = 'http://' . $bo_facebook;
								}
								?>
								<div class="col"><img src="<?php echo WEBSITE_IMG_URL ?>Facebook-min.png" /><span><a href="<?php echo $bo_facebook; ?>">Facebook</a></span></div>
							<?php } ?>
						 </li>
						 <li>
						<?php 
							if(!empty($casino->bo_ph)){
								$bo_ph 	=	$casino->bo_ph;  ?>
								<div class="col"><img src="<?php echo WEBSITE_IMG_URL ?>Phone-min.png" /><span><?php echo $bo_ph; ?></span></div>
						<?php }  
							if(!empty($casino->bo_tw)){
								$bo_tw 	=	$casino->bo_tw;
								if (false === strpos($bo_tw, '://')) {
									$bo_tw = 'http://' . $bo_tw;
								} ?>
								<div class="col"><img src="<?php echo WEBSITE_IMG_URL ?>Twitter-min.png" /><a href="<?php echo $bo_tw; ?>">Twitter</a></div>
							<?php } ?>
						 </li>
						 <li>
						 ...
						 <span class="hading_h2">Group Sales</span>
					  <ul class="casino_detInfo cont-info">
						<li>
						 <?php 
							if(!empty($casino->gs_web)){
								...
								?>
								<div class="col"><img src="<?php echo WEBSITE_IMG_URL ?>Website-min.png" /><a href="<?php echo $gs_web; ?>">Website</a></div>
							<?php } 
							if(!empty($casino->gs_facebook)){
								$gs_facebook 	=	$casino->gs_facebook;
								if (false === strpos($gs_facebook, '://')) {
									$gs_facebook = 'http://' . $gs_facebook;
								}
								?>
								<div class="col"><img src="<?php echo WEBSITE_IMG_URL ?>Facebook-min.png" /><span><a href="<?php echo $gs_facebook; ?>">Facebook</a></span></div>
							<?php } ?>
						 </li>
						 <li>
						<?php 
							if(!empty($casino->gs_ph)){
								$gs_ph 	=	$casino->gs_ph;  ?>
								<div class="col"><img src="<?php echo WEBSITE_IMG_URL ?>Phone-min.png" /><span><?php echo $gs_ph; ?></span></div>
						<?php }  
							if(!empty($casino->gs_tw)){
								$gs_tw 	=	$casino->gs_tw;
								if (false === strpos($gs_tw, '://')) {
									$gs_tw = 'http://' . $gs_tw;
								} ?>
								<div class="col"><img src="<?php echo WEBSITE_IMG_URL ?>Twitter-min.png" /><a href="<?php echo $gs_tw; ?>">Twitter</a></div>
							<?php } ?>
						 </li>
						 <li>
					  ...
					  <span class="hading_h2 cont-info">Conferences</span>
					  <ul class="casino_detInfo cont-info">
						<li>
						 <?php 
							if(!empty($casino->cf_web)){
								...
								?>
								<div class="col"><img src="<?php echo WEBSITE_IMG_URL ?>Website-min.png" /><a href="<?php echo $cf_web; ?>">Website</a></div>
							<?php } 
							if(!empty($casino->cf_facebook)){
								$cf_facebook 	=	$casino->cf_facebook;
								if (false === strpos($cf_facebook, '://')) {
									$cf_facebook = 'http://' . $cf_facebook;
								}
								?>
								<div class="col"><img src="<?php echo WEBSITE_IMG_URL ?>Facebook-min.png" /><span><a href="<?php echo $cf_facebook; ?>">Facebook</a></span></div>
							<?php } ?>
						 </li>
						 <li>
						<?php 
							if(!empty($casino->cf_ph)){
								$cf_ph 	=	$casino->cf_ph;  ?>
						...
						<?php }  
							if(!empty($casino->cf_tw)){
								...
								<div class="col"><img src="<?php echo WEBSITE_IMG_URL ?>Twitter-min.png" /><a href="<?php echo $cf_tw; ?>">Twitter</a></div>
							<?php } ?>
						 </li>
						 <li>
						 <?php 
						...
						<div class="Active_post">
						   ...
						   <div class="block">
									  ...
									  <div class="flexslider banner_slide" id="photoslider<?php echo $iid; ?>">
										 <ul class="slides">
											...
											$show = true;
											   foreach($casino_activity_datas->casino_activity->casino_images as $image)
											   {
													if(file_exists(CASINO_FULL_IMG_ROOT_PATH.$image->file)){ $show=false; ?>
														<li class="h_auto">
														   <?php echo $this->Html->image(WEBSITE_UPLOADS_URL.'image.php?width=400px&height=200px&cropratio=2:1&image='.CASINO_FULL_IMG_URL.$image->file,['class' => 'img-responsive','alt' => 'Image']); ?>
														</li>
												<?php 
												   }
											   }
											if($show){
												 ?>
												   <li class="h_auto">
													   <?php echo $this->Html->image(WEBSITE_UPLOADS_URL.'image.php?width=400px&height=200px&cropratio=2:1&image='.NO_ACTIVITY_IMG,['class' => 'img-responsive','alt' => 'Image']); ?>
													</li>
												   <?php
											} ?>
										 </ul>
							...
							<?php 		} 
								 ...
								 <span><?php echo $casino_activity_datas->casino_activity->title; ?></span>
								...
								if(!empty($casino_activity_datas->casino_activity->schedule)){
									$schedule = unserialize($casino_activity_datas->casino_activity->schedule); ?>
									 <span class="hide" id="showSch<?php echo $iid; ?>"><?php echo $this->Html->image(WEBSITE_IMG_URL.'timer.png'); ?> Schedule:</span>
									 <ul class="tel_info schedule_ul">
									<?php 
									$showSch	=	false;

         ...
         <div class="banner-content">
            ...
            <div class="search-back">
               <div class="top-search" data-ng-app>
                  <input type="text" data-ng-model="city_name" name="city_name" id="city_name" class="autocomplete1" value="" placeholder="<?= __('homepage.type_in_the_destination_or_casino name'); ?>" >
                        ...
                        <div class="img_block">
                           ...
                           <div class="overlay">
                              <span><a href="<?php 
                                 ...
                                 ?>"><?php echo $popularCasino->text ?></a></span>
                              <p><a class="f15" href="<?php 
                                 if($popularCasino->type == 'normal'){
                                 echo $this->Url->build(['plugin' => '','controller' => 'Casinos','action' => 'casino_view','casino_view' => $popularCasino->casino->slug]);
                                 }else{
                                 echo $this->Url->build(['plugin' => '','controller' => 'Casinos','action' => 'casino_view','casino_view' => $popularCasino->casino->slug]);
                                 }
                                 ?>"><?php echo isset($popularCasino->casino->city->name) ? $popularCasino->casino->city->name : ''; ?></a></p>
                           </div>
                        </div>
                     </li>
                     <?php } ?>

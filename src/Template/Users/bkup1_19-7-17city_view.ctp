<div class="mid_wrapper"><?php 
  ...
  <div class="clowdInfo"  data-ng-app="myApp"  data-ng-controller="myCtrl"><?php //echo $this->element('add_review_popup'); ?>
    <div class="container">
      	<div class="clowdTop">
        	<div class="pull-left">
        	...
        	<div class="pull-right"> <a href="">Add Info</a> <span>/</span> <a  href="javascript:void(0);"  data-type="city" data-id="<?php echo $cityDetail->id; ?>" class="add-photos-click">Add Photos</a>
        	</div>
        </div>
        <div class="row">
            		...
            		<div class="clowdIn col_info2">
              			<div class="col">
                			...
                			<p><?php echo $cityDetail->population ?> hab.</p>
                				<div class="pull-left"><img src="<?php echo WEBSITE_URL; ?>images/poblacion_icon.png" alt="icon" width="32" height="37">
                				</div>
              			</div>
              		</div>
              		<div class="col">
		...
		<div class="col-lg-6 col-md-6">
        	<div class="clowdRight" data-ng-class="no_rec ? 'hide' : ''">
            	...
            	<div class="clowdIn hide weather">
              	...
              	<div class="col">
					<div class="dgriCol m"><span>Wind Speed</span><span data-ng-show="temp">{{wind_speed_c | number : 0 }} km/h</span><span data-ng-show="!temp">{{wind_speed_f | number : 0 }} mph</span>
					</div>            
...
<div class="explore-img explore-img1 shadwo_none">
   ...
   <div class="container">
		...
		<?php foreach($recommedCasinos as $casino){ ?>
				<div class="item_D1">
				    <div class="item_img">
				   		<a href="<?php echo $this->Url->build(['plugin' => '','controller' => 'casinos','action' => 'online_casino_view','online_casino_view' => $casino->slug]) ?>"><?php 

         ...
         <div class="experience-user">
			...
			foreach($reviewList as $review){ 
				...
				$html	=	'<div class="whole-block">
						 ...
						 <div class="col-md-3">
							<div class=""> <img src="'.$userImage.'" class="img-responsive man ####class####"> </div>
						 </div>
						 <div class="col-md-9">
							<div class="man-matter">
							   <p><a href="'.$reviewUserSlug.'" class="style">'.$review->user->full_name.'</a> was in <a href="'.$htmlurl.'" class="style">'.$name.'</a></p>
							   <p><img src="'.WEBSITE_IMG_URL.'location.png" alt="img">Visited: '.$cityName.$review->created->format(Configure::read('Date.'.$Defaultlanguage)).'</p>
							   <p class="review"><samp>Review</samp><span  class="readonly" data-score="'.$review->rating.'"></span></p>
							</div>
						 </div>
						 <div class="paregraph">

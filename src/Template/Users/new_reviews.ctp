  ...
  <div class="NewReviewsBan back_img_5 ">
      ...
      <div class="container">
         <div class="Reviewsbanner">
            <h1>New Reviews</h1>
            <h3>Read about the most recent experience of our users
            <!-- See the experiences more recent of some of the members of Casinolineup --></h3>
			...
			foreach($reviewList as $review){ 
				...
				$reviewUserSlug	=	$this->Url->build(array('controller' => 'users','action' => 'user_slug' ,'user_slug' => $review->user->slug));
					...
					$utb_tm = current(explode(',', $utb_tm));
						...
						$img_alt= $name.' review';
				    $rd_to_cmnt = $htmlurl.'#rw_div';
				    $html	= '<div class="whole-block">
						 <div class="user-area"><a href="'.$htmlurl.'">
							<img alt="'.$img_alt.'" src="#####akshay#####" class="img-responsive">
							<span class="user-area-new">'.$name.'</span></a>
						 </div>
						 <div class="col-md-3">
							<div class="">
						 ...
						 <div class="paregraph" id = "rdmore_redirect">
							<p class="readmore_redirect" rdlink="'.$rd_to_cmnt.'">
								<span class="fa fa-quote-left qt_lft">
								</span>'.nl2br($review->comment).'
								<span class="fa fa-quote-right qt_rt">
								</span>
							</p>
						 </div>
						 <div id="cls_qut" class="hide">
						 	<span class="fa fa-quote-right qt_rt">
						 	</span>
						 </div>
					  </div>';

<div id="page-wrapper">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="col-lg-6">
				<h1 class="page-header">Casino Amount List</h1>
			</div>
			<div class="col-lg-6">
				<?php echo $this->Html->link('Add New',array('action' => 'add_amount'),array('class' => 'btn btn-primary','style' => array('float: right; margin-top: 58px;'))); ?>
			</div>
		</div>
		<!-- /.col-lg-12 -->
	</div>
									...
									foreach ($casinos as $casino):
										...
										<tr>
											...
											<td>
												...
												<?php //echo $this->Form->postLink(__('Delete'), ['action' => 'casino_request_delete', $casino->id], ['confirm' => __('Are you sure you want to delete # {0}?', $casino->id),'class' => 'btn btn-danger']) ?>
											</td>
										</tr>	
									 <?php endforeach;

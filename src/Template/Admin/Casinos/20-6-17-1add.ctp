						...
						<div class="col-lg-12">
							<?php echo $this->Form->create($casino,array('role' => 'form','type' => 'file','novalidate' => true)); ?>
								...
								<div class="form-group">
									...
									/*echo $this->Form->input('state_name', array(
										'id' =>'state_name',
									'type' => 'select',
										'options' => $states,
											'empty' => 'select state'
								...
								<div class="form-group">
									...
									<?php //echo $this->Form->select("city_id:city_name",$city,array('class' => 'form-control city_id','empty' => 'Select city','id' => 'Cites'));
									?>
								...
								<div class="form-group">
									...
									<?php
									 echo $this->Form->textarea("description",array('class' => 'form-control','placeholdder' => 'Description','id' =>'body')); $this->Html->scriptStart(array('block' => 'custom_script')); ?>
					...
					<?php $this->Html->scriptEnd(); ?>
							...
							<div class="sss">
								...
								<div class="form-group">
									...
									<ul>
									<?php foreach($casinoActivities as $ame){ $id	=	$ame->id; ?>
										<li>
											<label for="<?php echo "casinoActivities.".$id ?>" class="checkbox">
												<?php echo $this->Form->checkbox("casinoActivities.".$ame->id,array('id' => "casinoActivities.".$id)); ?><strong><?php echo $ame->title; ?></strong>
											</label>
											<ul>
											<?php foreach($ame->child_masters as $child_masters ){ ?>
												<li>
													<label for="<?php echo "casinoActivities_child.".$child_masters->id; ?>" class="checkbox">
													<?php echo $this->Form->checkbox("casinoActivities.".$ame->id.".".$child_masters->id,array('id' => "casinoActivities_child.".$child_masters->id)); ?>
													<?php echo $child_masters->title; ?></label>
												</li>
											<?php } ?>
											</ul>
										</li>
								...
								<div class="form-group">
									<label>Image</label>
									 <div id="container">
										<?php 
										$object_id = rand(1000000,9999999999);
...
$("#Countries").change(function(){
	...
	<!-- $('#state').load('/Admin/casino/getStates/'+cntryid); -->

	...
	<div class="navbar-default sidebar" role="navigation">
		<div class="sidebar-nav navbar-collapse">
			<ul class="nav" id="side-menu">
						...
						<li>
						 ...
						 <li>
							<a href="<?php echo $this->Url->build('/admin/real_casinos/index'); ?>">Fetched Real Casino</a>
								...
								<li>
							<a href="<?php echo $this->Url->build('/admin/casinos/stnd'); ?>">Standard Image for Real Casino</a>
						</li>
						<li>
				...
				<li>
					<a class="<?php echo ($controller == 'upload-images') ? 'active' : ''; ?>" href="<?php echo $this->Url->build('/admin/casinos/casino_request'); ?>"><i class="fa  <?php echo ($controller == 'upload-images') ? 'fa-cog fa-spin' : 'fa-user fa-fw'; ?> fa-fw"></i>Casino Approval Request</a>
				</li>
				<li>
					<a class="<?php echo ($controller == 'upload-images') ? 'active' : ''; ?>" href="<?php echo $this->Url->build('/admin/casinos/casino_amount'); ?>"><i class="fa  <?php echo ($controller == 'upload-images') ? 'fa-cog fa-spin' : 'fa-user fa-fw'; ?> fa-fw"></i>Casino Amount</a>
				</li>
				<li>

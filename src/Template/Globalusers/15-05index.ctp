   ...
   <div class="deshboardInfo  banner_textblock ">
      ...
      <div class="deshInfo">
         <div class="container">
            ...
            <div class="Contributions Casinoswop" id="cntributions">
               
            </div>
            <div id="edit_settings" class="Contributions Casinoswop" ng-controller="DashboardTabCntrl">
               <h2 class="deshtitle">Settings</h2>
                ...
                <div ng-class="$root.iconclass=='basic' ? '' : 'hide'" class="deshSettings">
    ...
    [
        ...
        ['value' => 'female', 'text' => 'Female','ng-model' => "formData.sex"]
                     ...
                     <div class="block"><input type="button" class="btn red_btn" ng-click="updateProfile()" value="Update" /></div>
                  <?php echo $this->Form->end(); ?>
               </div>
				<div ng-class="$root.iconclass=='noti' ? '' : 'hide'" class="deshSettings">
                  <?php 
				...
				<div ng-class="$root.iconclass=='pref' ? '' : 'hide'" class="deshSettings Preferences">
					<?php 
				   ...
				   <div class="checkList">
					...
					<div class="block">
						<input type="button" data-rel="accountPref" value="Update" class="btn red_btn noti_update">
					</div>
				   <?php echo $this->Form->end(); ?>
				</div>
			</div>

				...
				foreach($allMessage as $message){
					...
					<tr>
						<td>
							...
							<a data-type="<?php echo $type; ?>" href="javascript:void(0)" data-id="<?php echo $message->id; ?>" class="message_view"><?php echo ($type == 'inbox') ? $message->sender->full_name.' ('.$message->sender->email.')' :  $message->receiver->full_name.' ('.$message->receiver->email.')' ; ?></a>
						</td>

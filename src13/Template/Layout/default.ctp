...
<?php }
	...
	/* if(Configure::read('debug')){ */
		echo $this->Html->css(array('bootstrap.css','custom.css','font-awesome.css','autocomplete.css','jquery.raty.css','pnotify.custom.min.css','stylesheet.css'),array('block' =>'css'));
	/* }else{
...
if(Configure::read('debug')){
	echo $this->Html->script(array('jquery.min.js','bootstrap.min.js','angular.min.js','jquery.flexslider.js','jquery.form.min.js','autocomplete.js','jquery.raty.js','pnotify.custom.min.js'),array('block' =>'script'));
}else{

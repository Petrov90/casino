...
<div class="row">
	...
	<div class="row">
		<div class="col-lg-6">
			<h1 class="page-header">Update online casino</h1>
		</div>
		<div class="col-lg-6">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12" ng-app="plunker"  ng-controller="MainCtrl">
							<?php echo $this->Form->create($casino,array('type' => 'file','role' => 'form','novalidate' => true)); ?>
								...
								<div class="form-group">
									...
									<?php  foreach($country as $key => $name){
										$isChecked	=	(!empty($restricated_countries) && in_array($key,$restricated_countries)) ? 'checked="checked"' : '' ;  ?>
										<div class="col-lg-4">
											<label for="<?php echo "country_id1.".$key; ?>" style="margin:7px;cursor:pointer;font-weight: unset;"><?php echo $name ?></label>										
											<?php echo $this->Form->checkbox("country_id1.".$key,array('id' => "country_id1.".$key,$isChecked)); ?>
										 </div>																		 
									 <?php
									} ?>
									 </div>	
								...
								<div class="form-group">
									...
									<?php echo $this->Form->select("live_chat",$live_chat,array('class' => 'form-control autocomplete','empty' => false,'required' => false)); ?>
									<?php echo $this->Form->error("live_chat"); ?>
								</div>
								<div class="form-group">
									<label>Manual flushing</label>
									<?php echo $this->Form->select("manual_flushing",$manual_flushing,array('class' => 'form-control autocomplete','empty' => false,'required' => false)); ?>
					...
					<?php echo $this->Form->error("fdescription"); ?>
								...
								<div class="form-group">
									...
									<?php  foreach($devices as $key => $name){
										$isChecked	=	(!empty($casino_devices) && in_array($key,$casino_devices)) ? 'checked="checked"' : '' ;  ?>
										<div class="col-lg-4">
											<label for="<?php echo "devices.".$key; ?>" style="margin:7px;cursor:pointer;font-weight: unset;"><?php echo $name ?></label>										
											<?php echo $this->Form->checkbox("devices.".$key,array('id' => "devices.".$key,$isChecked)); ?>
										 </div>																		 
									 <?php
									} ?>
									 </div>	
								...
								<div class="form-group">
									...
									<?php  foreach($currencies as $key => $name){
										$isChecked	=	(!empty($casino_currencies) && in_array($key,$casino_currencies)) ? 'checked="checked"' : '' ;	 ?>
											 <div class="col-lg-4">
												<label for="<?php echo "currencies.".$key; ?>" style="margin:7px;cursor:pointer; font-weight: unset;"><?php echo $name ?></label>
												<?php echo $this->Form->checkbox("currencies.".$key,array('id' => "currencies.".$key,$isChecked)); ?>
											 </div>
								...
								<div class="form-group">
									...
									<?php  foreach($language as $key => $name){
											$isChecked	=	(!empty($casino_language) && in_array($key,$casino_language)) ? 'checked="checked"' : '' ; ?>
											 <div class="col-lg-4">
												<label for="<?php echo "language.".$key; ?>" style="margin:7px;cursor:pointer; font-weight: unset;"><?php echo $name ?></label>
												<?php echo $this->Form->checkbox("language.".$key,array('id' => "language.".$key,$isChecked)); ?>
											 </div>
								...
								<div class="form-group">
									...
									<?php  foreach($software as $key => $name){
										$isChecked	=	(!empty($casino_software) && in_array($key,$casino_software)) ? 'checked="checked"' : '' ;  ?>
										<div class="col-lg-4">
											<label for="<?php echo "software.".$key; ?>" style="margin:7px;cursor:pointer;font-weight: unset;"><?php echo $name ?></label>										
											<?php echo $this->Form->checkbox("software.".$key,array('id' => "software.".$key,$isChecked)); ?>
										 </div>																		 
									 <?php
									} ?>
									 </div>	
								...
								<div class="form-group">
									...
									<?php  foreach($deposit_methods as $key => $name){ 
											$isChecked	=	(!empty($casino_deposit_methods) && in_array($key,$casino_deposit_methods)) ? 'checked="checked"' : '' ;  ?>
											 <div class="col-lg-4">
												<label for="<?php echo "deposit_methods.".$key; ?>" style="margin:7px;cursor:pointer; font-weight: unset;"><?php echo $name ?></label>
												<?php echo $this->Form->checkbox("deposit_methods.".$key,array('id' => "deposit_methods.".$key,$isChecked)); ?>
											 </div>
								...
								<div class="form-group">
									...
									<?php  foreach($withdrawal_methods as $key => $name){
										$isChecked	=	(!empty($casino_withdrawal_methods) && in_array($key,$casino_withdrawal_methods)) ? 'checked="checked"' : '' ;
									?>
											 <div class="col-lg-4">
												<label for="<?php echo "withdrawal_methods.".$key; ?>" style="margin:7px;cursor:pointer; font-weight: unset;"><?php echo $name ?></label>
												<?php echo $this->Form->checkbox("withdrawal_methods.".$key,array('id' => "withdrawal_methods.".$key,$isChecked)); ?>
											 </div>
								...
								<div class="form-group">
									...
									<?php  foreach($licences as $key => $name){
										$isChecked	=	(!empty($casino_licences) && in_array($key,$casino_licences)) ? 'checked="checked"' : '' ; ?>  <div class="col-lg-4">
												<label for="<?php echo "licences.".$key; ?>" style="margin:7px;cursor:pointer; font-weight: unset;"><?php echo $name ?></label>
												<?php echo $this->Form->checkbox("licences.".$key,array('id' => "licences.".$key,$isChecked)); ?>
											 </div>
											 <?php
									} ?>
										 </div>
								...
								<div class="form-group">
									...
									<?php  foreach($withdrawal_limit as $key => $name){
										$isChecked	=	(!empty($casino_withdrawal_limit) && in_array($key,$casino_withdrawal_limit)) ? 'checked="checked"' : '' ;
									 ?>
											 <div class="col-lg-4">
												<label for="<?php echo "withdrawal_limit.".$key; ?>" style="margin:7px;cursor:pointer; font-weight: unset;"><?php echo $name ?></label>
												<?php echo $this->Form->checkbox("withdrawal_limit.".$key,array('id' => "withdrawal_limit.".$key,$isChecked)); ?>
											 </div>

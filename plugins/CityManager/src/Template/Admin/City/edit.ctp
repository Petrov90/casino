...
<div id="page-wrapper" style="min-height: 140px;">
	...
	<?php 	foreach($lanagauageList as $lanagauage){
				...
				<div class="col-lg-12 form-group">
					...
					<?php echo $this->Form->text("first_head",array('class' => 'form-control','required' => false));
					echo $this->Form->error("first_head"); ?>
				</div>
	            ...
	            <div class="col-lg-12 form-group">
	                <label>              
	                  ...
	                  <?php  echo $this->Form->textarea('first_block',array('class' => 'form-control','placeholdder' => 'Description First','id' =>$code.'first_block','required' => $required));
                        $this->Html->scriptStart(array('inline' => true,'block' => 'custom_script')); ?>
                            CKEDITOR.replace( '<?php echo $code;?>first_block',
                            {} );
                        <?php $this->Html->scriptEnd(); 
                        echo ($lanagauage->is_default == 1) ? $this->Form->error("first_block") : ''; ?>
	            </div>	
	            <div class="col-lg-12 form-group">
	                <label>              
	                    Second Block
	                </label>
	                  <?php  echo $this->Form->textarea('second_blok',array('class' => 'form-control','placeholdder' => 'Description Second','id' =>$code.'second_blok','required' => $required));
                        $this->Html->scriptStart(array('inline' => true,'block' => 'custom_script')); ?>
                            CKEDITOR.replace( '<?php echo $code;?>second_blok',
                            {} );
                        <?php $this->Html->scriptEnd(); 

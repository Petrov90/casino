...
/*		$validator->add('name', [
		...
		// 	'rule' => 'validateUnique',
		// 	'provider' => 'table',
		// 	'message' => 'Slug is already  exists.Please enter a unique slug.'
		// ]);	
        ...
        $validator
  		 ...
  		 //$validator->add('name',[
				//'nameUniqueCheck'=>[
				//	'rule'	  	=>  'nameUniqueCheck',
				//	'provider' 	=>  'table',
				//	'message'	=>	'City already exists.Please enter another city'
				// ]
			//]);
    ...
    public function nameUniqueCheck($value,$context){
		$name	 	 =	$context['data']['name'];
		$cntry	 	 =	$context['data']['country_id'];
		$CasinoImage	 =  TableRegistry::get('Cities');
		$CasinoImage	 =	$CasinoImage->find('all')->where(array('name' => $name,'country_id' => $cntry))->first();

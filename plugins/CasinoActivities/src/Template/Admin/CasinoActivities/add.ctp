...
<div class="row">
	...
	<div class="row">
		<div class="col-lg-6">
			<h1 class="page-header">Add new aminities</h1>
		</div>
		<div class="col-lg-6">
						...
						<div class="col-lg-12">
							<?php echo $this->Form->create($casino,array('type' => 'file','novalidate' => true)); ?>
								...
								<div class="form-group">
									...
									<span style="color:red">Leave blank to make parent</span>
								</div>
								<div class="form-group">
									<label>Title</label>
							...
							<div id="test_01" class="<?php echo (empty($this->request->data['parent_id'])) ? 'hide' : ''; ?>">
								<div class="form-group">

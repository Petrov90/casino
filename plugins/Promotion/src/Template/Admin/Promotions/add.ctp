						...
						<div class="col-lg-12">
							<?php echo $this->Form->create($casino,['type' => 'file']); ?>
								<div class="form-group">
									<label>Casino</label>
									<?php echo $this->Form->text("casino_name",array('class' => 'form-control autocomplete','empty' => true,'placeholder' => 'Search Any Casino','required' => true)); 
								...
								<div class="form-group">
									...
									<?php echo $this->Form->text("title",array('class' => 'form-control','placesholder' => 'Title','ng-model' => 'name','required' => true)); ?>   
									<?php echo $this->Form->error("title"); ?>
								</div>
								<!-- Add By Ghanshyam-->
								<div class="form-group">
									<label>Bonus Amount </label>
									<?php echo $this->Form->text("bonus_amount",array('class' => 'form-control','placesholder' => 'Bonus Amount','ng-model' => 'name','required' => true)); ?>   
								...
								<div class="form-group">
									...
									<?php echo $this->Form->textarea("amount",array('class' => 'form-control','placesholder' => 'Amount','required' => true)); ?>   
								...
								<div class="form-group">
									...
									<?php  foreach($bonus_type as $key => $name){
									 ?>
											 <div class="col-lg-4">
												<label for="<?php echo "gambling_options.".$key; ?>" style="margin:7px;font-weight:100;width:60%;cursor:pointer"><?php echo $name ?></label>
								...
								<div class="form-group">
									...
									<div id="ddd">
										<?php if(!empty($this->request->data['text1'])){ 
										foreach($this->request->data['text1'] as $text){ ?>

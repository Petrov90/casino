<div id="page-wrapper">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="col-lg-6">
				<h1 class="page-header">Promotions List</h1>
			</div>
			<div class="col-lg-6">
				<?php echo $this->Html->link('Add New Promotions',array('action' => 'add'),array('class' => 'btn btn-primary','style' => array('float: right; margin-top: 58px;'))); ?>
			</div>
		</div>
		<!-- /.col-lg-12 -->
	</div>
				...
				<div class="panel-body">
					<div class="table-responsive1">
						<div class="row">
							<div class="col-sm-12">
								...
								<div class="col-sm-9">
									...
									<div class="col-sm-5"> <?php echo $this->Form->text("title",array('class' =>'form-control','placeholder' => 'Search by casino','value' => isset($requestedQuery['title']) ? $requestedQuery['title'] : '')); ?></div>
									<div class="col-sm-4">
						...
						<table class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									<th width="25%"><?php echo $this->Paginator->sort('title','Title'); ?></th>
									<th width="25%"><?php echo 'Casino title'; ?></th>
							...
							<tbody>
								<?php 
									foreach ($Promotionss as $Promotions):
										...
										?>
										<tr>
											<td><?= h($Promotions->title) ?></td>
											<td><?php echo isset($Promotions->casino->title) ? $Promotions->casino->title : '';?></td>
											<td>
											<?php 
										if(!empty($Promotions->logo) && (PROMOTION_CASINO_LOGO_ROOT_PATH.$Promotions->logo)){
											...
											if(!empty($Promotions->casino->image) && (CASINO_THUMB_IMG_ROOT_PATH.$Promotions->casino->image)){
												echo $this->Html->image(CASINO_THUMB_IMG_URL.$Promotions->casino->image,['height' => 100,'width' => 100]);
											}
										} ?></td>
											<td>
										<div class="btn-group">
